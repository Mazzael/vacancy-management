...
import br.com.vmazza.vacancy_management.modules.company.useCases.CreateJobUseCase;
...
public class JobController {
    ...
    @Operation(summary = "Vacancy creation", description = "This route is responsible for creating the vacancy of an enterprise")
    @ApiResponses({
